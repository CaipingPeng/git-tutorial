...
建议先把上面的最小路径练熟，再读快进合并、三方合并和冲突细节。会处理冲突比会背所有合并术语更重要。
...
常见的 difftool: VS Code, Meld, KDiff3, Beyond Compare, P4Merge
...
**推荐工具**: VS Code (免费), Meld (Linux), KDiff3 (全平台), Beyond Compare (专业)
